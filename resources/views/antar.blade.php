            ...
            <form class="space-y-4 text-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-center">
                        ...
                        <input type="text" class="flex-1 border border-gray-300 rounded px-3 py-2 bg-gray-100"
                            placeholder="">
                    </div>
                    <div class="flex items-center">
                        <label class="w-32 font-medium text-center">Tanggal</label>
                        <input type="date" class="flex-1 border border-gray-300 rounded px-3 py-2 bg-gray-100">
                    </div>
                </div>
                ...
                <div class="grid gap-4">
                    ...
                    <div class="flex items-center">
                        <label class="w-32 font-medium">Nomor WA</label>
                        <input type="text" class="flex-1 border border-gray-300 rounded px-3 py-2 bg-gray-100">
                    </div>
                    <div class="flex items-center">
                        <label class="w-32 font-medium">Jumlah Orang</label>
                        <input type="number" class="flex-1 border border-gray-300 rounded px-3 py-2 bg-gray-100">
                    </div>
                    <div class="flex items-center">
                ...
                <div class="mt-6">
                    ...
                    <div class="border rounded p-4 mt-5">
                        <input type="text" placeholder="Isi Tujuan Anda disini..."
