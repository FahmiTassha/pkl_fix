    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-4xl font-medium text-black">SYARAT & KETENTUAN</h1>
                    <p class="text-sm pt-3 text-gray-500">Admin / <span class="text-black">Syarat & Kentuan</span></p>
                </div>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-100 text-[#6C757D]">
                        <tr>
                            ...
                            <th class="px-4 py-2 border font-normal w-48">Ketentuan</th>
                            <th class="px-4 py-2 border font-normal w-35">Reservasi</th>
                    ...
                    <tbody id="motorTableBody">
                        @foreach ($sks as $i => $sk)
                            <tr>
                                ...
                                <td class="px-4 py-2 border max-w-[200px] truncate">{{ $sk->ketentuan }}</td>
                                <td class="px-4 py-2 border max-w-[200px] truncate">{{ $sk->reservasi }}</td>
                                <td class="px-4 py-2 border text-center space-x-2">
                                    <a href="{{ route('admin.sk.show', $sk->id) }}"
                                    ...
                                    <form action="{{ route('admin.sk.destroy', $sk->id) }}" method="POST"
                                        class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="px-2 py-1 border rounded hover:bg-red-100 text-red-600"
                                            onclick="return confirm('Yakin hapus Syarat & Ktentuan Ini ini?')">
