    ...
    <div class="flex min-h-screen">
            ...
            <nav class="flex-1">
                <ul class="space-y-3">
                    <li>
                        ...
                        class="inline-flex items-center pl-4 py-3 pr-5 mt-5 bg-[#006895] rounded-lg text-white hover:bg-[#00577a]">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-4xl font-medium text-black">Sewa Mobil</h1>
                    <p class="text-sm pt-3 text-gray-500">Admin / <span class="text-black">Sewa Mobil</span></p>
                </div>
            </div>
            ...
            <div id="mobilTable" class="bg-white mt-8 px-5 py-4 rounded-md">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody id="mobilTableBody">
                        @foreach ($mobils as $i => $mobil)
                            <tr>
                                <td class="px-4 py-2 border text-center">{{ $i + 1 }}</td>
                                <td class="px-4 py-2 border">{{ $mobil->nama }}</td>
                                ...
                                <td class="px-4 py-2 border">{{ $mobil->tempat }}</td>
                                <td class="px-4 py-2 border">Rp {{ number_format($mobil->harga, 0, ',', '.') }}</td>
