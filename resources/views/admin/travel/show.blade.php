    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
           ...
           <div class="bg-white p-6 rounded-lg max-w-5xl flex gap-6 mt-10">
                ...
                <div class="flex-1 space-y-4">
                    <div>
                        <h2 class="text-lg font-semibold">Nama Paket Travel:</h2>
                        <p>{{ $travel->nama }}</p>
                    </div>

                    <div>
                        <h2 class="text-lg font-semibold">Orang:</h2>
                        <p>{{ $travel->orang }}</p>
                    </div>

                    <div>
                        <h2 class="text-lg font-semibold">Harga / Hari:</h2>
                        <p>Rp {{ number_format($travel->harga, 0, ',', '.') }}</p>
                    </div>

                    <div>
                        <h2 class="text-lg font-semibold">Deskripsi:</h2>
                        <p>{{ $travel->deskripsi }}</p>
                    </div>

                    <div>
                        <h2 class="text-lg font-semibold">Destinasi:</h2>
                        <p>{{ $travel->destinasi }}</p>
                    </div>

                    <div>
                        <h2 class="text-lg font-semibold">Include:</h2>
                        <p>{{ $travel->Include }}</p>
                    </div>
        ...
        <div class="flex-shrink-0 mt-35 mr-20">
            <div class="h-56 w-56 bg-white rounded-lg shadow-md flex items-center justify-center">
                @if($travel->gambar)
                    <img src="{{ asset('travel/' . $travel->gambar) }}" 
                        alt="{{ $travel->nama }}" 
