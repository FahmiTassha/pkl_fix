        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm pt-3 text-gray-500">Admin / <span class="text-black">Paket Tour</span></p>
                </div>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-100 text-[#6C757D]">
                        <tr>
                            ...
                            <th class="px-4 py-2 border font-normal">Detail Paket</th>
                    ...
                    <tbody id="mobilTableBody">
                        @foreach ($tours as $i => $tour)
                            <tr>
                                ...
                                <td class="px-4 py-2 border">{{ $tour->nama }}</td>
                                ...
                                <td class="px-4 py-2 border">{{ $tour->tempat }}</td>
                                <td class="px-4 py-2 border">Rp {{ number_format($tour->harga, 0, ',', '.') }}</td>
                                <td class="px-4 py-2 border max-w-[200px] truncate">{{ $tour->deskripsi }}</td>
                                <td class="px-4 py-2 border max-w-[200px] truncate">{{ $tour->destinasi }}</td>
                                <td class="px-4 py-2 border max-w-[200px] truncate">{{ $tour->include }}</td>
                                <td class="px-4 py-2 border text-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.tour.destroy', $tour->id) }}" method="POST"
                                        ...
                                        <button type="submit" class="px-2 py-1 border rounded hover:bg-red-100 text-red-600"
                                            onclick="return confirm('Yakin hapus paket tour ini?')">
