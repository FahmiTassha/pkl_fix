        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm pt-3 text-gray-500">Admin / S&K / <span class="text-black">Tambah S&K</span></p>
                </div>
            </div>
            ...
            <div class="max-w-4xl mt-10 pl-6 pr-6 pt-6 rounded-lg bg-white min-h-screen">
                ...
                <form action="{{ route('admin.sk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="ketentuan" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700">Reservasi</label>
                        <input type="text" name="reservasi" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring" required>
                    </div>
