    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between items-center mb-6"> 
                <div>
                    <h1 class="text-4xl font-medium text-black flex items-center">
                     <img src="{{ asset('icon/panahkiri.png') }}" alt="panah" class="w-8 h-8 mr-2">{{ $mobil->nama }}</h1>
                    <p class="text-sm pt-3 text-gray-500">
                        Admin / Sewa Mobil / 
                        <span class="text-black">{{ $mobil->nama }}</span>
                    </p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.mobil.update', $mobil->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700">Nama Mobil</label>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700">Tempat Duduk</label>
                    <input type="text" name="tempat" value="{{ old('tempat', $mobil->tempat) }}"
                        class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring" required>
                </div>
